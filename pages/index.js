...
export default function Home() {
  ...
  */
  ...
  async function loadHardHatResell() {
    ...
    loadHHSaleNFTs();   //calling next HH funtion
  }
  async function loadHHSaleNFTs() {    //to show created nfts
  ...
  async function buyNewHH(nft) {    //to buy newly created NFTs
    ...
    loadHHSaleNFTs()      //re-loads hh listed nfts
  }
