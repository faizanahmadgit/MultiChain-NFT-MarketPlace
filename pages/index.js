...
export default function Home() {
  ...
  async function loadNewSaleNFTs() {    //to show created nfts
  ...
  async function buyNewNft(nft) {    //to buy newly created NFTs
  ...
  return (
    <div>
      ...
      <Container sm>
        ...
        <Grid.Container gap={1} justify="flex-start">
          {
            hhnfts.slice(0, 9).map((nft, i) => ( //indexing created nfts one by one
              <Grid xs={3}>
                <Card style={{ marginRight: '3px', boxShadow: '1px 1px 10px #ffffff' }} variant="bordered" key={i}>
                  ...
                  <Card.Footer css={{ justifyItems: "flex-start" }}>
                    <Row wrap="wrap" justify="space-between" align="center">
                      ...
                      <Button color="gradient" style={{ fontSize: '20px' }} onPress={() => handleConfetti(buyNewNft(nft))}>Buy</Button>
                    </Row>
                  </Card.Footer>
                </Card>
              </Grid>
